...
public class sns_mayak_toast1 extends AppCompatActivity {

    private Button btnAdd, btnMinus;
    private TextView tvCount;
    private int count = 1;
    private TextView toast, egg, jeonbun;
    private int toast_num = 200;
    private int egg_num = 1;
    private int jeonbun_num = 1;
    ...
    androidx.activity.result.ActivityResultLauncher<Intent> ActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            if (result.getResultCode() == Activity.RESULT_OK) {
                ...
                scrapPage.scrapped.add(new scrapFoodListByFolderName(new scrapfolderNames(folder),new scrapFoods(R.drawable.mayak_toast,"마약토스트",15)));
            }
        }
    });
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sns_mayak_toast1);
        ...
        bookmark.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!bookmark_pressed){
                    ...
                    Intent intent = new Intent(sns_mayak_toast1.this, scrapfolderName.class);
                    ...
                    for(scrapFoodListByFolderName item : scrapPage.scrapped){
                        if(item.scrapFood.equals(new scrapFoods(R.drawable.mayak_toast,"마약토스트",15))){
        ...
        toast = findViewById(R.id.toast_num);
        egg = findViewById(R.id.egg_num);
        jeonbun = findViewById(R.id.jeonbun_num);

        toast.setText(toast_num+"");
        egg.setText(egg_num+"");
        jeonbun.setText(jeonbun_num+"");
        ...
        adopt.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_Sweettoast2.class);
