...
public class diet_ChickenbreastBok2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.diet_chickenbreast_bok2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:{
                Intent intent2 = new Intent(getApplicationContext(), diet_chicken_breast_soysauce_bokkeumbap.class);  // 눌렀을 때 메인화면으로 이동하기
