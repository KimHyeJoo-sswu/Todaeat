...
public class china_baechu_jjajang2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.china_baechu_jjajang_2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:{
                Intent intent2 = new Intent(getApplicationContext(), china_baechu_jjajang1.class);  // 눌렀을 때 메인화면으로 이동하기
