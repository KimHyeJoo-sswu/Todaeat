...
public class sns_Honeyjelly2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sns_honeyjelly2);//요리 끝 버튼 누르면 -> 캘린더로 이동
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent2 = new Intent(getApplicationContext(), sns_honey_jelly.class);  // 눌렀을 때 메인화면으로 이동하기
