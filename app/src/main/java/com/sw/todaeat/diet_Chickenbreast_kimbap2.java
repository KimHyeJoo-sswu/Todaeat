...
public class diet_Chickenbreast_kimbap2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.diet_chickenbreast_kimbap2);
        //요리 끝 버튼 누르면 -> 캘린더로 이동
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:{
                Intent intent2 = new Intent(getApplicationContext(), diet_chicken_breast_kimbap.class);  // 눌렀을 때 메인화면으로 이동하기
