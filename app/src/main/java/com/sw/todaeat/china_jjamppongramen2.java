...
public class china_jjamppongramen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.china_jjamppongramen_2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:{
                Intent intent2 = new Intent(getApplicationContext(), china_jjamppong_ramen1.class);  // 눌렀을 때 메인화면으로 이동하기
