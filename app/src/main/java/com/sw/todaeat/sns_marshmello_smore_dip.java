...
public class sns_marshmello_smore_dip extends AppCompatActivity {
    ...
    androidx.activity.result.ActivityResultLauncher<Intent> ActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            if (result.getResultCode() == Activity.RESULT_OK) {
                ...
                scrapPage.scrapped.add(new scrapFoodListByFolderName(new scrapfolderNames(folder),new scrapFoods(R.drawable.marshmellow_smoredip,"마시멜로우 스모어 딥",20)));
            }
        }
    });
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sns_marshmello_smore_dip1);
        ...
        bookmark.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!bookmark_pressed){
                    ...
                    Intent intent = new Intent(sns_marshmello_smore_dip.this, scrapfolderName.class);
                    ...
                    for(scrapFoodListByFolderName item : scrapPage.scrapped){
                        if(item.scrapFood.equals(new scrapFoods(R.drawable.marshmellow_smoredip,"마시멜로우 스모어 딥",20))){
        ...
        adopt.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_mashmallow2.class);
