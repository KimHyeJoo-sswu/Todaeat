...
public class sns_honey_jelly extends AppCompatActivity {

    private Button btnAdd, btnMinus;
    private TextView tvCount;
    private int count = 1;
    private TextView honey;
    private int honey_num = 500;
    ...
    androidx.activity.result.ActivityResultLauncher<Intent> ActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            if (result.getResultCode() == Activity.RESULT_OK) {
                ...
                scrapPage.scrapped.add(new scrapFoodListByFolderName(new scrapfolderNames(folder),new scrapFoods(R.drawable.honey_jelly,"꿀젤리",60)));
            }
        }
    });
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sns_honey_jelly1);
        ...
        bookmark.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!bookmark_pressed){
                    ...
                    Intent intent = new Intent(sns_honey_jelly.this, scrapfolderName.class);
                    ...
                    for(scrapFoodListByFolderName item : scrapPage.scrapped){
                        if(item.scrapFood.equals(new scrapFoods(R.drawable.honey_jelly,"꿀젤리",60))){
        ...
        honey = findViewById(R.id.honey_num);

        honey.setText(honey_num+"");
        ...
        adopt.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_Honeyjelly2.class);
