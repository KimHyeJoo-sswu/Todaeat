...
public class MainActivity_sns extends AppCompatActivity {
    //추가된 소스
    Toolbar myToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_pencake_cereal1.class);
                startActivity(intent);
            }
        });
        ...
        image2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_honey_jelly.class);
                startActivity(intent);
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_natures_cereal1.class);
                startActivity(intent);
            }
        });
        ...
        image4.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_mayak_toast1.class);
                startActivity(intent);
            }
        });
        ...
        image5.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), sns_marshmello_smore_dip.class);
                startActivity(intent);
            }
        });
